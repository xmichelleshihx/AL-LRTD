...
with open('cholec80_server.pkl', 'wb') as f:
    pickle.dump(all_info_all, f)

import pickle

with open('cholec80_server.pkl', 'rb') as f:
...
pdb.set_trace()
with open('train40_val8_test41-80_paths_labels_server.pkl', 'wb') as f:
